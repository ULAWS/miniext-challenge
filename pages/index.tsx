...
export function Home() {
    ...
    if(auth.type !== LoadingStateTypes.LOADED || auth.user === null) return <></>
    return (
        <div className={styles.container}>
            ...
            {auth.user.phoneNumber === null  && <PhoneVerification />}
            {auth.user.email === null  && <EmailVerification />}
             {auth.user.phoneNumber!=null && auth.user.email !== null &&   
